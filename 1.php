      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/tower_box.jpg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Tower Explosion Box</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Tower Explosion Box</h1>
          ...
          This <b>Tower Explosion Box</b> comprises of 36 pictures.You can customize the color combination and number of pictures according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Pictures :</b> 36<br>
