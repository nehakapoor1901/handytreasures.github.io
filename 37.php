      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/family1.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Family String Art (Nuclear)</b></h5></center>
                
              </div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Price : 1900</li>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Family String Art (Nuclear)</h1>
          ...
          This <b>Family String Art (Nuclear)</b> comprises of thread art of 3 family memebers.You can customize the number of family members and size of board according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Number of Family Members :</b> <br>
          <b>Title of Board:</b><br>
