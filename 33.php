      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/family2.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Family String Art (Joint)</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Family String Art (Joint)</h1>
