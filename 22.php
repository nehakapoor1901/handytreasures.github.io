      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/krishna.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Krishna String Art</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Krishna String Art</h1>
          ...
          This <b>Krishna String Art</b> comprises of thread art.You can customize the name and size of board according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Name :</b> <br>
