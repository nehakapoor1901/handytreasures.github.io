      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/choclate.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Choclate Bouquet</b></h5></center>
                
              </div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Price : 900</li>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Choclate Bouquet</h1>
          ...
          This <b>Choclate Bouquet</b> comprises of 32 Dairy milk chocloates and 27 coin chocolates.You can customize the color combination and number of choclates according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Number of Choclates :</b> 32+27/Other(Please specify the number)<br>
