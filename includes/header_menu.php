                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#all" class="dropdown-item">All Products</a>
                                   <a href="stringart.php#string" class="dropdown-item">String Arts</a>
                                   <a href="box.php#box" class="dropdown-item">Cards & Boxes</a>
                                   <a href="album.php#alb" class="dropdown-item">Albums</a>
                               </div>
