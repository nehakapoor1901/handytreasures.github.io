      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/loverstring.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Lover String Art</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Lover String Art</h1>
          ...
          This <b>Lover String Art</b> comprises of thread art of two names and heart between them.You can customize the size of name of lovers on the board according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Name :</b> <br>
