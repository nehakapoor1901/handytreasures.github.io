      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              ...
              <div class="card-body">
                <center><h5 class="card-title"><b>Birthday Memory Book</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Birthday Memory Book</h1>
          ...
          This <b>Birthday Memory Book</b> comprises of 50 pictures.You can customize the color combination and number of pictures according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Pictures :</b> 50<br>
