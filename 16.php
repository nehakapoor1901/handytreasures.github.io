      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/reason.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>99 Reasons Why <br> I Love You Jar</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">99 Reasons Why <br> I Love You Jar</h1>
          ...
          This <b>99 Reasons Why I Love You Jar</b> comprises of 99 mini messages.You can customize the color combination of mini slips and number of slips according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Pictures :</b> 99<br>
          <b>Color Combination :</b> Same/Other(if any specified) <br>
          <b>Theme</b> : Birthday/Anniversary/Other<br>
          <b>We should write messages according to theme or You wil send us 99 messages : </b> Please Specify clearly (Don't use abbreviations)
          <b>Any Special Message Particularly:</b> <br>
