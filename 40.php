      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/heartname.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Name & Heart String Art</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Name & Heart String Art</h1>
          ...
          This <b>Name & Heart String Art</b> comprises of thread art with name and hearts on both sides of name.You can customize the name according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>name:</b> <br>
