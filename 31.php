      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/rakhi.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Rakhi/Bhaiduj Card</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Rakhi/Bhaiduj Card</h1>
          ...
          This <b>Rakhi/Bhaiduj Card<b>comprises of 4 pictures 1 rakhi 1 dairy milk silk choclate and 1 roli.You can customize the color combination and number of pictures and type of choclate according to you.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Pictures :</b> 36<br>
          <b>Type of Chocolate:</b><br>
