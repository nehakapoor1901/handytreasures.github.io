      ...
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <div class="card" style="width: 30rem;">
              <img class="card-img-top" src="pictures/frame.jpeg" alt="Card image cap">
              <div class="card-body">
                <center><h5 class="card-title"><b>Frame & Pot Combo</b></h5></center>
        ...
        <div class="col-md-4 mt-2">
          <span class="text-warning pt-3">
            <h1 class="title">Frame & Pot Combo</h1>
          ...
          This <b>Frame & Pot Combo</b> comprises of 1 mini flower pot and 10 X 15 frame..You can customize the Picture or Quote of photoframe according to you flower pot will be provided according to color availibilty.Share these details to us on <b> Mail id : treasureshandy@gmail.com </b> or (from the button given below) or <b>Whatsapp </b>(from the button given below).<br><br>
          <b>Pictures / Quote :</b> Specify Which one<br>
